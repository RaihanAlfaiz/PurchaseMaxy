<div class="sidebar-wrapper active">
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item has-sub @if (in_array(Route::currentRouteName(), ['products.index', 'customers.index', 'suppliers.index'])) active @endif">
                <a href="#" class='sidebar-link '>
                    <i class="fa fa-box"></i>
            ...
            <li class="sidebar-item has-sub @if (in_array(Route::currentRouteName(), ['sales-orders.index'])) active @endif">
                <a href="#" class='sidebar-link '>
                ...
                <ul class="submenu list-unstyled ps-3">
                    <li class="submenu-item">
                        <a class="nav-link " href="{{ route('sales-orders.index') }}">Sales Order</a>
                    </li>
                </ul>
            </li>

            <li class="sidebar-item has-sub @if (in_array(Route::currentRouteName(), ['purchase-orders.index'])) active @endif">
                <a href="#" class='sidebar-link '>
                ...
                <ul class="submenu list-unstyled ps-3">
                    <li class="submenu-item">
                        <a class="nav-link " href="{{ route('purchase-orders.index') }}">Purchase Order</a>
                    </li>
                </ul>
            </li>
